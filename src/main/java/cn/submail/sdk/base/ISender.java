...
import cn.submail.sdk.Mail;

/**
 * A interface define a method of {@link #send(java.util.Map)}.All classes what can send
...
public interface ISender {
	 ...
	 * @param data {@link java.util.HashMap}contains the request data.Such as
	 * <p>
	 * to->xxx@submail.cn
	 * cc->nnn@submail.cn
	 * text->Hello,world!
